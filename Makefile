# Description: Makefile for Python MCP Prometheus Documentation Server

PROJECT_NAME := mcp-prometheus-documentation
TARGET := ./target
...
index: ## Build the documentation index
	...
	$(PYTHON) -m mcp_prometheus_documentation.cli index
